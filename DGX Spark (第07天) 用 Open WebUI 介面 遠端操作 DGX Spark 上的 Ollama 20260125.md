...
>   - 重開機之後，在 DGX Spark **本機使用** Ollama，只要執行 `Step 5-1`，超級簡單
>   - 重開機之後，在 電腦/平板/手機 Client **遠端操作** DGX Spark Server 的 Ollama 服務，只要執行 `Step 4-2` 與 `Step 5-1`，超級簡單
...
(不要做)(改成以下步驟)
## 改為 Step 8. 停用/再次啟用 Open WebUI 自動啟動
### 改為 Step 8-1. 停用
